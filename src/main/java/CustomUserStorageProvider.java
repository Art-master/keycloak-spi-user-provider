...
public class CustomUserStorageProvider implements UserStorageProvider, UserLookupProvider, UserQueryProvider, CredentialInputUpdater,
    ...
    public CustomUserStorageProvider(KeycloakSession session, ComponentModel componentModel, Repository repository) {
    ...
    public UserModel getUserById(RealmModel realm, String id) {
        ...
        User user = repository.findUserById(externalId);
